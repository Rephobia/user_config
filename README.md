...
localhost-st                     # configure st terminal
localhost-kitty                  # configure kitty terminal
...
localhost-rofi                   # configure dmenu
localhost-syncthing              # configure syncthing
localhost-samba-fstab            # configure (mount) samba with fstab
localhost-samba-gio              # configure (mount) samba with gio
